      ...
      <div className="flex gap-x-40 ">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div
            className={`${
              darkMode ? "dark:bg-black text-white  " : ""
            } flex items-center space-x-2 bg-gray-100 rounded-full w-24 h-9 hover:bg-gray-200 cursor-pointer`}
          >
            <img
          ...
          <div
            className={`${
              darkMode ? "dark:bg-black text-white  " : ""
            }flex items-center space-x-2 bg-gray-100 rounded-full w-32 h-9 hover:bg-gray-200 cursor-pointer`}
          >
            <img
      ...
      <div
        className={`${
          darkMode
            ...
            : ""
        }rounded-xl p-3 w-[850px] overflow-y-hidden bg-gray-200 whitespace-pre-line text-sm`}
      >
        <div className="flex space-x-2">
